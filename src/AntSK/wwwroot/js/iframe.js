async function embedChatbot() {
    ...
    <svg width="48px" height="50px" viewBox="0 0 48 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink">
    ...
    MessageIconImg.style.cssText = 'width: 100%; height: 100%; transition: transform 0.3s ease;';
    const ChatBtn = document.createElement('div');
    ChatBtn.id = chatBtnId;
    ChatBtn.style.cssText = 'position: fixed; bottom: 1rem; right: 1rem; width: 200px; height: 200px; cursor: pointer; z-index: 2147483647;';
    ...
    iframe.parentElement.appendChild(resizer);
    ...
    function resetTimer() {
        clearTimeout(timer);
        timer = setTimeout(() => {
            if (!isScaledAndTranslated) {
                MessageIconImg.style.transform = 'scale(0.5) translate(50%, 90%)';
                isScaledAndTranslated = true;
            }
        }, 5000);
    }
    ...
    ChatBtn.addEventListener('click', function () {
        ...
        if (visibilityVal === 'hidden') {
            ...
            ChatBtn.style.cssText = 'position: fixed; bottom: 1rem; right: 1rem; width: 40px; height: 40px; cursor: pointer; z-index: 2147483647;';
    ...
    ChatBtn.addEventListener('mouseenter', () => {
        if (isScaledAndTranslated) {
            MessageIconImg.style.transform = 'scale(1) translate(0, 0)';
            isScaledAndTranslated = false;
        }
    });
